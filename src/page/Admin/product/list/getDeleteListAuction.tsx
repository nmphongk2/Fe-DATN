...
const deleteListProductAuction: React.FC = () => {
  ...
  return (
    <div>
      <ReusableBreadcrumb items={breadcrumbItems.deleteListAuction} />
      <div className="mb-4 ml-4 col-span-full xl:mb-2">
        <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">
          Danh sách xóa mềm sản phẩm đấu giá
        </h1>
      </div>
        ...
        <div className="mb-4 col-span-full xl:mb-2">
          <div className="bg-white dark:bg-gray-800 relative border shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <AdminFetDeleteListProductAuction />
            </div>
          </div>
        </div>
      </section>
...
export default deleteListProductAuction;
