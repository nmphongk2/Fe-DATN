...
import { getAllServices } from "../../../../redux/servicesRef/serviceRefThunk";
import { DeleteBiddingRequest } from "../../../../types/deleteBid/deleteBid";
import { deleteBiddingThunk } from "../../../../redux/deleteBid/deleteBidThunk";
...
const DeleteBidModal: React.FC<DeleteBidModalProps> = ({
  bidId,
  onClose,
  onDelete,
  isOpen,
  ...
  const onSubmit: SubmitHandler<FormValues> = (data) => {
    ...
    const deleteRequest: DeleteBiddingRequest = {
      userId: userId,
      biddingId: bidId,
    ...
    dispatch(deleteBiddingThunk(deleteRequest));
    dispatch(fetchBidsByUserThunk(userId));
    onDelete(); // Call onDelete instead of onConfirm
