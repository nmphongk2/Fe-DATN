    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                console.log('Default Category ID:', brand.category_id);  // Kiểm tra giá trị category_id
                console.log('Default Supplier ID:', brand.supplier_id); 

                if (brand.image) {
                    const url = await getFileFirebase(brand.image);
          setImgPreview(url);
                }
                setLoading(false);
            } catch (error) {
  ...
  const onSubmit = async (data: IFormInput) => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
            <ToastContainer />
            <ReusableBreadcrumb items={breadcrumbItems.editBrands} />
            ...
            <div className="grid grid-cols-[1fr_2fr] px-4 pt-4 xl:grid-cols-[1fr_2fr] xl:gap-4 dark:bg-gray-900">
                <div className="col-span-full xl:col-auto">
                    ...
                    <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                        <h3 className="mb-4 text-xl font-semibold dark:text-white">Danh mục &amp; Nhà cung cấp</h3>
                        <div className="mb-4">
                            <label
                        ...
                        <div className="mb-4">
                            ...
                            {errors.supplier_id && (
                                <span className="text-red-600">{errors.supplier_id.message}</span>
                            )}
                        </div>
                    </div>
                </div>
