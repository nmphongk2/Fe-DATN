...
import { DeleteListProductThunk, hardDeleteThunk } from "../../../../../redux/product/admin/Thunk";
...
export const hardDeleteProduct = (
  ...
  MySwal.fire({
    ...
    if (result.isConfirmed) {
      try {
        const action = await dispatch(hardDeleteThunk(productId));
        if (hardDeleteThunk.rejected.match(action)) {
